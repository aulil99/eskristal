...
<div class="col-md-8">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control form-control-sm uang <?= (form_error('stok')) ? 'is-invalid' : ''; ?>" id="stok" name="stok" placeholder="Stok yang Tersedia" value="<?= (set_value('stok')) ? set_value('stok') : $barang->stok; ?>">
            <div class="invalid-feedback">
